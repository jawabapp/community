...
use Jawabapp\Community\Http\Requests\Account\Block\UnblockRequest;
...
class UnblockController extends Controller
{
    ...
    public function index($accountId, UnblockRequest $request)
    {
        ...
        $account->blocks()->where('block_account_id', $blockAccount->id)->delete();
